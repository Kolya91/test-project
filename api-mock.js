...
(function (window, angular, undefined) {
    ...
    angular.module('httpAPIMock', ['ngMockE2E'])
        .run(function ($httpBackend) {
            ...
            $httpBackend.whenGET('partials/files.html').passThrough();
            $httpBackend.whenGET('partials/preview.html').passThrough();
            $httpBackend.whenGET('partials/templates/file-preview.tpl.html').passThrough();
